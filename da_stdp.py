...
if __name__ == "__main__":
	...
	subplot(132)
	plot(state_monitor.t/second, state_monitor.w[0])
	plot(state_monitor.t/second, state_monitor.w[1])
	plot(state_monitor.t/second, state_monitor.w[2])
	plot(state_monitor.t/second, state_monitor.w[3])
	plot(state_monitor.t/second, state_monitor.w[4])
	plot(state_monitor.t/second, state_monitor.r[0])
	xlabel('Time (s)')
	ylabel('Weight')
